...
namespace Tower_of_hanoi_implementation
{
    ...
    public class Stick : PictureBox
    {
        ...
        public Stick(int load,int top,int id)
        {
            this.load = load;
            this.top = top;
            this.id = id;
    ...
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.stick1 = new Stick(3,0,0); //all discs initially on the first stick
            ...
            this.disc3.Cursor = Cursors.Hand;
            // 
            // disc2
            // 
            ...
            this.disc2.Cursor = Cursors.Hand;
            ...
            this.disc1.Cursor = Cursors.Hand;
            ...
            this.button4.Location = new System.Drawing.Point(498, 444);
